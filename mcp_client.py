...
client = MultiServerMCPClient(
    {
        ...
        "weather": {
            ...
            "command": r"C:\Anaconda_New\envs\travel\python.exe",

            # Automatically use custom_weather_mcp_server.py
            # from the current project directory.
            "args": [
                r"C:\Users\prath\OneDrive\Desktop\Gen_AI\TripMate-AI--Multi-Agent-Travel-Planer-with-LangGraph\custom_weather_mcp_server.py"
            ],
